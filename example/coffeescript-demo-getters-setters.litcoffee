...
Or instead of a factory but with some generic amendable class the same effect
using instance_property. Also, listing the above method class_property again: 

    Function::constructor_property = ( prop, desc ) ->
      Object.defineProperty @, prop, desc

    Function::class_property = ( prop, desc ) ->
      Object.defineProperty @prototype, prop, desc

    class PropertiesObj

        instance_property: ( prop, desc ) ->
            Object.defineProperty @, prop, desc

        @constructor_property 'constructorProp',
            get: () -> 'constructorProp'

        @class_property 'classProp',
            get: () -> 'classProp'

    propObj = new PropertiesObj
    propObj.instance_property 'instanceProp',
            get: () -> 'instanceProp'

    ok propObj.instanceProp is 'instanceProp'
    ok propObj.classProp is 'classProp'
    ok propObj.constructor.constructorProp is 'constructorProp'
